...
public class LibroJpaController implements Serializable {
    ...
    public void create(Libro libro) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findLibro(libro.getIsbn()) != null) {
                throw new PreexistingEntityException("El Libro " + libro.getTitulo() + " ya existe.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void destroy(long id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("El libro con id " + id + " no existe.", enfe);
            }
            em.remove(libro);
            em.getTransaction().commit();
        } finally {
    ...
    public List<Libro> encontrarLibrosAutor(Autor autor) {
        EntityManager em = getEntityManager();
        try {
    ...
    public List<Libro> encontrarLibrosEditorial(Editorial editorial) {
        EntityManager em = getEntityManager();
        try {
            return em.createQuery("SELECT l FROM Libro l WHERE l.editorial LIKE :autor", Libro.class)
